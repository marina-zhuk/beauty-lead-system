      ...
      <div className="mx-auto grid max-w-7xl gap-4 border-t border-ink/10 pt-6 text-sm text-ink/65 md:grid-cols-[1fr_1.4fr_1fr] md:items-start">
        ...
        <div className="border-l border-ink/10 pl-4">
          ...
          <p className="mt-2 leading-6">
            Демо-проект для портфолио: показывает прием заявки, Telegram-уведомление
            и запись в Google Sheets. Перед использованием в реальном бизнесе нужна адаптация.
          </p>
        </div>
